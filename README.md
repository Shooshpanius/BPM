...
- **Уведомления** — in-app (SignalR + persistent inbox), rich HTML email (шаблоны), actionable email (одноразовые токены), SMS (configurable HTTP-провайдер), Web Push / PWA (VAPID, Service Worker)
