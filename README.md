...
[![Version](https://img.shields.io/badge/version-0.0.99-informational?style=flat-square)](CoreBPM/CoreBPM/corebpm.client/src/version.ts)
...
| # | Подсистема | Прогресс | % |
|---|-----------|----------|---|
| 1 | Аутентификация и авторизация | `█░░░░░░░░░░░░░░░░░░░` | 5% |
| 2 | Профиль и оргструктура | `████████████░░░░░░░░` | 62% |
| 3 | Главная страница и портал | `████░░░░░░░░░░░░░░░░` | 20% |
| 4 | Бизнес-процессы | `████████████████████` | 97% |
| 5 | Задачи | `████████████████████` | 95% |
| 6 | Документооборот | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 7 | Трудозатраты | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 8 | Календарь | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 9 | CRM (Клиенты) | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 10 | Сообщения и уведомления | `████████████████████` | ~100% |
| 11 | Справочники (Объектная модель) | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 12 | Бизнес-правила | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 13 | Конструктор интерфейсов (Low-code UI) | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 14 | Интеграции | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 15 | Отчёты и аналитика | `░░░░░░░░░░░░░░░░░░░░` | 0% |
| 16 | Администрирование | `█░░░░░░░░░░░░░░░░░░░` | 5% |
...
- **Задачи** — создание, назначение, согласование, трудозатраты (включая отчёт по трудозатратам), контроль сроков; массовый контроль; типы задач: периодические, по процессу, по резолюции документа; расширенные диалоги действий (Сделано/Невозможно/Начать/Закрыть с комментарием и уведомлением соисполнителей), перенос срока, открыть заново, взять задачу из очереди (claim), наблюдатели, вопросы по задаче, @mentions в комментариях; самоподписка (watch/unwatch), расширенные уведомления наблюдателей на все события, напоминания, планирование в календаре (ScheduledAt + iCalendar-экспорт), дашборд задач, настройки уведомлений пользователя; группы задач (Входящие/Исходящие/На контроле/Соисполнение), цветовое кодирование и иконки типов, сортировка по клику на заголовок, группировка, режимы таблица/карточки, Excel/CSV-экспорт, EQL-поиск, SignalR push-счётчики в Sidebar; отложено: многоуровневое согласование, шаблоны маршрутов, справочник приоритетов (admin), корректировка сроков по производственному календарю, привязка к мероприятию/проекту
- **Документы** — шаблоны, маршруты согласования, электронная подпись
- **Уведомления** — in-app (SignalR + persistent inbox), rich HTML email (шаблоны), actionable email (одноразовые токены), SMS (configurable HTTP-провайдер), Web Push / PWA (VAPID, Service Worker); матрица каналов пользователя (in-app/email/SMS/push) на уровне типа события, режим «Не беспокоить» (расписание по часам и дням недели), глобальные шаблоны с переменными `{{task.name}}`/`{{user.fullName}}`, принудительные каналы доставки (флаги IsMandatory*), журнал доставки с фильтрацией по пользователю/типу события/каналу/статусу/периоду
