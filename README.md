...
- **Задачи** — создание, назначение, согласование, трудозатраты (включая отчёт по трудозатратам), контроль сроков; массовый контроль; типы задач: периодические, по процессу, по резолюции документа
