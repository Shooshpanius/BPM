...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest corebpm.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`corebpm.client.esproj`).
