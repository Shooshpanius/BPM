...
import type { NotificationSettingDto, DndSettingsDto } from '../../api/tasksApi';
...
/** Страница настроек уведомлений — матрица каналов и режим DND (FR-MSG-02.2). */
export function NotificationSettingsPage() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            .then(([s, d]) => { setSettings(s); setDnd(d); })
