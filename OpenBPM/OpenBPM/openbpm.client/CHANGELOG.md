...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest openbpm.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`openbpm.client.esproj`).
